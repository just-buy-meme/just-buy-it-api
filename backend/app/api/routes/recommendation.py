...
from app.services.recommendation import run_stock_recommender_workflow
...
async def recommend_endpoint(request: ChatRequest, req: Request):
    """
    ...
    try:
        ...
        async def event_generator():
            try:
                async for event in run_stock_recommender_workflow(
                    messages,
                    request.debug,
                ):
